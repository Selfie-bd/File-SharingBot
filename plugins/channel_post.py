...
async def channel_post(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("⚜️ Share URL ⚜️", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"<b>👇Here is your link👇</b>\n\n➲ {link} \n\n<b>〽️ Powered by @GroupDcBots <b>", reply_markup=reply_markup, disable_web_page_preview = True)
